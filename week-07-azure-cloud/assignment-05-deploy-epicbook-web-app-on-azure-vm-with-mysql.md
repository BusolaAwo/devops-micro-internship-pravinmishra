...
![alt text](<screenshots/week 07-assignment 5-task1-screenshot1.JPG>)

![alt text](<screenshots/week 07-assignment 5-task1-screenshot1a.JPG>)

---

#### Screenshot 2 — Public and private NSG inbound rules showing ports 80, 22, and restricted 3306 access

![alt text](<screenshots/week 07-assignment 5-task1-screenshot2.JPG>)

![alt text](<screenshots/week 07-assignment 5-task1-screenshot2a.JPG>)

---

#### Screenshot 3 — Public IP and Network Interface association for the Virtual Machine

![alt text](<screenshots/week 07-assignment 5-task1-screenshot3.JPG>)
...
![alt text](<screenshots/week 07-assignment 5-task2-screenshot4.JPG>)

---

#### Screenshot 5 — Terminal showing successful software installation or installed-version checks

![alt text](<screenshots/week 07-assignment 5-task2-screenshot5.JPG>)
...
![alt text](<screenshots/week 07-assignment 5-task4-screenshot9.JPG>)

---

#### Screenshot 10 — Networking configuration showing the private subnet and restricted access

![alt text](<screenshots/week 07-assignment 5-task4-screenshot10.JPG>)

---

#### Screenshot 11 — MySQL Client output showing the EpicBook database or imported tables (no password visible)

![alt text](<screenshots/week 07-assignment 5-task4-screenshot11.JPG>)
...
![alt text](<screenshots/week 07-assignment 5-task5-screenshot12.JPG>)

---

#### Screenshot 13 — Proof of a successful database-backed action (viewing products, adding to cart, or placing an order)

![alt text](<screenshots/week 07-assignment 5-task5-screenshot13.JPG>)
